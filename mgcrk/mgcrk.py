...
def print_to_file(filename, unique_list_finished):
    ...
    f.close()
    print(
        "\033[92m[+]\033[0m Saving dictionary to \033[1;31m"
        + filename
        + "\033[1;m, counting \033[1;31m"
        + str(lines)
        + " words.\033[1;m"
    )
    inspect = input("\033[92m[+]\033[0m Hyperspeed Print? (Y/n) : ").lower()
    if inspect == "y":
        try:
    ...
    print(
        "\033[92m[+]\033[0m Now load your pistolero with \033[1;31m"
        + filename
...
def print_cow():
    print("    __  ___                       ______                __   _")
    print("   /  |/  /__  ____ _____ _      / ____/________ ______/ /__(_)___  ____ _")
    print("  / /|_/ / _ \/ __ `/ __ `/_____/ /   / ___/ __ `/ ___/ //_/ / __ \/ __ `/")
    print(" / /  / /  __/ /_/ / /_/ /_____/ /___/ /  / /_/ / /__/ ,< / / / / / /_/ /")
    print("/_/  /_/\___/\__, /\__,_/      \____/_/   \__,_/\___/_/|_/_/_/ /_/\__, /")
    print("            /____/      W O R D L I S T  G E N E R A T O R       /____/")
...
def improve_dictionary(file_to_open):
    ...
    conts = input(
        "\033[92m[+]\033[0m Do you want to concatenate all words from wordlist? Y/[N]: "
    ).lower()

    if conts == "y" and len(listic) > CONFIG["global"]["threshold"]:
        print(
            "\r\n\033[91m[-]\033[0m Maximum number of words for concatenation is "
            + str(CONFIG["global"]["threshold"])
        )
        print("\033[91m[-]\033[0m Check configuration file for increasing this number.\r\n")
        conts = input(
            "\033[92m[+]\033[0m Do you want to concatenate all words from wordlist? Y/[N]: "
        ).lower()
    ...
    spechars = [""]
    spechars1 = input(
        "\033[92m[+]\033[0m Do you want to add special chars at the end of words? Y/[N]: "
    ).lower()
    if spechars1 == "y":
        for spec1 in chars:
    ...
    randnum = input(
        "\033[92m[+]\033[0m Do you want to add some random numbers at the end of words? Y/[N]:"
    ).lower()
    leetmode = input("\033[92m[+]\033[0m Leet mode? (i.e. leet = 1337) Y/[N]: ").lower()
    ...
    print("\r\n\033[92m[+\033[0m Now making a dictionary...")

    print("\033[92m[+]\033[0m Sorting list and removing duplicates...")
...
def interactive():
    ...
    while len(name) == 0 or name == " " or name == "  " or name == "   ":
        print("\033[91m[-]\033[0m You must enter a name at least!")
    ...
    while len(birthdate) != 0 and len(birthdate) != 8:
        print("\r\n\033[91m[-]\033[0m You must enter 8 digits for birthday!")
        birthdate = input("Birthdate (DDMMYYYY): ")
    ...
    profile["words"] = [""]
    words1 = input(
        "\033[92m[+]\033[0m Do you want to add some key words about the victim? Y/[N]: "
    ).lower()
    words2 = ""
    if words1 == "y":
        words2 = input(
            "\033[92m[+]\033[0m Please enter the words, separated by comma. [i.e. hacker,juice,black], spaces will be removed: "
        ).replace(" ", "")
    ...
    profile["leetmode"] = input("\033[92m[+]\033[0m Leet mode? (i.e. leet = 1337) Y/[N]: ").lower()
...
def download_http(url, targetfile):
    print("\033[92m[+]\033[0m Downloading " + targetfile + " from " + url + " ... ")
...
def alectodb_download():
    ...
    print("\r\n\033[92m[+]\033[0m Checking if alectodb is not present...")
    ...
    print(
        "\r\n\033[92m[+]\033[0m Exporting to alectodb-usernames.txt and alectodb-passwords.txt\r\n[+] Done."
    )
...
def download_wordlist_http(filedown):
    ...
    if intfiledown in arguments:
        ...
        print("\033[92m[+]\033[0m files saved to " + dire)

    else:
        print("\033[91m[-]\033[0m leaving.")
